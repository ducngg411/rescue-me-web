...
export function LocationSection({
    ...
    // Map tab khởi động từ: vị trí đã chọn → vị trí GPS hiện tại → MapLocationPicker tự fallback
    const mapInitialCenter: [number, number] | undefined =
        incidentLocation
            ? [incidentLocation.lng, incidentLocation.lat]
            : currentLocation
    ...
    return (
        <div className="bg-white rounded-2xl p-4" style={{ boxShadow: '0 1px 8px rgba(0,0,0,0.06)' }}>
            ...
            {/* Card "Vị trí hiện tại" – chỉ hiện ở tab Tìm kiếm */}
            {pickerMode === 'search' && (
                <div
